...
spot6 = Spot.create(name:"Creekside Rock Haven", camp_type:"vrsite",img_url:"amazon", state_location:"Colorado",host_id:demoUser.id,campsite_id:campsite1.id,price:90,capacity:5,longitude:-105.6336124,latitude:40.3699838, description:"3 acres across road from Tarryall creek. Fishing access, Nice picnic area next to creek. ")
spot7 = Spot.create(name:"Vintage Rainbow Garden", camp_type:"vrsite",img_url:"amazon", state_location:"California",host_id:demoUser.id,campsite_id:campsite3.id,price:72,capacity:3,longitude:-118.895416,latitude: 36.440617,description:"Greetings Nature Lovers! We had an amazing 1st season, filled with amazing peeps who all contributed to making us lucky #12 in Cali!")
